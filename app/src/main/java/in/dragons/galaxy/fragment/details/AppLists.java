...
public class AppLists extends AbstractHelper {
    ...
    private void addAppsSimilar(String URL, String Label) {
        ...
        ImageView imageView = ViewUtils.findViewById(detailsFragment.getActivity(), R.id.apps_similar);
    ...
    private void addAppsRecommended(String URL, String Label) {
        ...
        ImageView imageView = ViewUtils.findViewById(detailsFragment.getActivity(), R.id.apps_recommended);
        imageView.setOnClickListener(v -> ClusterActivity.start(detailsFragment.getActivity(), URL, Label));
    }
    ...
    private void addAppsByThisDeveloper() {
        ...
        ImageView imageView = ViewUtils.findViewById(detailsFragment.getActivity(), R.id.apps_by_same_developer);
